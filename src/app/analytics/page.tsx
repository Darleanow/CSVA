...
export default function PreviousAnalyses() {
    ...
    const getColorForValue = (value: number, min: number, max: number) => {
        ...
        if (value >= (max * 0.8)) return '#1565C0';
        ...
        return (
            <Grid container spacing={3}>
                {Object.entries(stats).map(([key, value]) => {
                    ...
                    const max = Math.max(typedValue.max || 0, typedValue.mean * 2 || 0);
                    const min = Math.min(typedValue.min || 0, 0);
                            ...
                            <StyledCard variant="outlined">
                                <CardContent>
                                    ...
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                                        ...
                                        <Chip
                                            label={typedValue.mean?.toFixed(2) || 'N/A'}
                                            size="small"
                                            sx={{
                                                bgcolor: getColorForValue(typedValue.mean || 0, min, max),
                                                color: 'white',
                                                fontWeight: 'bold'
                                            }}
                                        />
                                    ...
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                                        ...
                                        <Chip
                                            label={typedValue['50%']?.toFixed(2) || 'N/A'}
                                            size="small"
                                            sx={{
                                                bgcolor: getColorForValue(typedValue['50%'] || 0, min, max),
                                                color: 'white',
                                                fontWeight: 'bold'
                                            }}
                                        />
                                    ...
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                                        ...
                                        <Typography variant="body2" fontWeight="medium">{typedValue.std?.toFixed(2) || 'N/A'}</Typography>
                                    </Box>
                                    ...
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                                        <Box>
                                            ...
                                            <Typography variant="body2" fontWeight="medium">{typedValue.min?.toFixed(2) || 'N/A'}</Typography>
                                        </Box>
                                        <Box>
                                            <Typography variant="caption" color="text.secondary" align="right">Max</Typography>
                                            <Typography variant="body2" fontWeight="medium">{typedValue.max?.toFixed(2) || 'N/A'}</Typography>
                                        </Box>
                                    </Box>
                                </CardContent>
                            </StyledCard>
