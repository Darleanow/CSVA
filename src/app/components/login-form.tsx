...
export default function LoginForm() {
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800 p-4 flex items-center justify-center">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 rounded-lg bg-zinc-800/50 text-zinc-200 border ${
                                        formErrors.email ? "border-red-500/50" : "border-zinc-700/50"
                            ...
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 rounded-lg bg-zinc-800/50 text-zinc-200 border ${
                                        formErrors.password ? "border-red-500/50" : "border-zinc-700/50"
                                    } placeholder-zinc-500 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition duration-200`}
                                />
                                {formErrors.password && (
